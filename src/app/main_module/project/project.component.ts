...
// const content = group.append('g').attr('transform', 'rotate(-45)');
...
//   .attr('x', -tileSize * 0.4)
//   .attr('y', -tileSize * 0.2)
//   .attr('width', tileSize * 0.35)
//   .attr('height', tileSize * 0.35);

// // Title
// content.append('text')
//   .attr('x', -tileSize * 0.05)
//   .attr('y', -tileSize * 0.1)
//   .attr('fill', 'white')
...
// const lines = tile.desc.match(/.{1,28}/g) || [];
// lines.forEach((line, j) => {
//   content.append('text')
//     .attr('x', -tileSize * 0.05)
//     .attr('y', -tileSize * 0.02 + j * tileSize * 0.08)
//     .attr('fill', 'white')
//     .attr('font-size', tileSize * 0.06)
//     .attr('font-family', 'sans-serif')
//     .attr('text-anchor', 'start')
//     .text(line);
// });
